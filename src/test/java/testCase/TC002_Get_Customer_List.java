...
import pojo.GetCustomerList;
import pojo.GetCustomerListResult;
import resources.ReusableMethod;

public class TC002_Get_Customer_List extends TestBase {
	...
	public void getCustomerList() throws IOException {
		tb = new TC002_Get_Customer_List();
		...
		response = httpRequest.request(Method.GET, "/appointment/get");
		...
		getCustomerList = objectMapper.readValue(body, GetCustomerList.class);
	}
	...
	public void getCustomerList_API_checkResponseBody() {
		...
		List<GetCustomerListResult> result = getCustomerList.getResult();
